...
<body>
    <div class="container">
        <h2>Law Firm Approval Status Update</h2>
        <p>Dear {{ $law_firm->first_name }} {{ $law_firm->last_name }},</p>
        <p>We are pleased to inform you that your profile has been approved successfully on our platform.</p>
        <p><strong>Law Firm ID:</strong> {{ $law_firm->id }}</p>
        <p><strong>Experience:</strong> {{ $law_firm->experience }} years</p>
        <p><strong>Address:</strong> {{ $law_firm->address_line_1 }}</p>
        <p><strong>Phone:</strong> {{ $law_firm->cell_phone }}</p>
